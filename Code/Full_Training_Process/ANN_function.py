...
class ANN_model:
    ...
    def create_ANN_model(self):
        ...
        model.compile(optimizer= Adam(learning_rate=0.005), loss='mean_absolute_percentage_error', metrics=['mean_absolute_percentage_error'])
        return model
    ...
    def find_best_ANN_model(self,X,y):
        ...
        for train_index, test_index in kf.split(X_scaled):
            ...
            model.fit(X_train, y_train, epochs=1000, batch_size=64, validation_split=0.15, verbose=1, callbacks=[early_stop])
